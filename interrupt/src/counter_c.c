...
#define IRQ1 176	// Byt ut 0 mot IRQ för knapp som räknar upp. Knappen närmast oss
#define IRQ2 175	// Byt ut 0 mot IRQ för knapp som räknar ner. Knappen i mitten
